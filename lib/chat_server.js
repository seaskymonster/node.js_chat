...
function joinRoom(socket, room){
    ...
    socket.emit('joinResult', {room: room}); // let user know they're now in the room
...
function handleMessageBroadcasting(socket){ // the server relays the message to all other users in the same room.
